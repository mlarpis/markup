...
<details>
<summary>Assumed prior knowlegde</summary>
...
**Using RStudio** <br>
RStudio is an R user's best friend. The IDE provides an enhanced interface for coding in R, with built-in support for markdown languages and R package development. If you're not familiar with R or RStudio, please follow the tutorial in our [crash course](https://hanneoberman.github.io/R101/) before continuing.
...
<details>
  ...
  **Install `RStudio`**<br>
  Install `RStudio` from [Posit's website](https://posit.co/products/open-source/rstudio/). Or use the online version via [posit.cloud](https://posit.cloud/plans). The free edition will suffice. 
</details>
