...
Welcome to `Quarto`. You have most likely already installed and used Quarto. If not, or if you feel that you need a refresher, please follow [this `Get Started`](https://quarto.org/docs/get-started/) guide. For all others, we have outlined a couple of relevant links and videos to get a quick grasp on reproducible academic publishing with `Quarto`. 
...
- a slide with your favorite equation
...
Of course this presentation may serve as the basis for presentations that you may have to create for other courses. Submit the presentation to your fork of [the deliverables template](https://github.com/mlarpis/portfolio). If you have not yet forked the template, do so now. See @sec-deliv for more information.