...
You can see a previous year's recording [here](https://www.dropbox.com/scl/fi/hscfsrh30slk23k7z6d1d/wk6_recording.mp4?rlkey=yhy7wt8ldfmsybbb3000z1hl0&dl=0) (download for the 1h+ recording)
:::
...
We need a location for our `R`-package. The simplest approach to creating the skeleton for an `R`-package is to use `RStudio`. 

::: {.content-visible when-format="html"}

::: {#fig-packagefolder}

The following gif outlines this procedure:
