...
8.  Post an issue in your forked template (remember @sec-deliv), wherein you properly [reference](https://docs.github.com/en/get-started/writing-on-github/working-with-advanced-formatting/autolinked-references-and-urls) your PR to the old course repo.
