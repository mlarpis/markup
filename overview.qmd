...
- Please post your content-related questions as [an issue in the course repository](https://github.com/mlarpis/markup/issues).
  - *Assign* the issue to one of the teachers so they get notified.
...
## Course manual
This course website serves as course manual. Background information, e.g. about course aims, can be found on [Osiris](https://osiris-student.uu.nl/#/onderwijscatalogus/extern/cursus?cursuscode=202000010&taal=en&collegejaar=huidig).
...
There are six topics discussed in this course (see [the course landing page](https://mlarpis.github.io/markup/)). Each topic includes a lecture with tutorial elements (or a seminar) and one or more exercises. Some topics have an associated [deliverable](https://mlarpis.github.io/markup/deliverables.html). 
...
### Exercises
The exercises associated with each topic allow students to gain experience with the skills in this course. The exercises are checked after each session by one of the teachers to monitor your progress and they count towards a percentage of the grade (see [Deliverables](https://mlarpis.github.io/markup/deliverables.html)). The exercises are aimed for students to practice learning objectives *c* and *d*: ‘They can efficiently organize a reproducible programming and development process’ and ‘They can produce repositories up to the standards of international programming and coding conventions and initiatives’ (see [the Osiris course text](https://osiris-student.uu.nl/#/onderwijscatalogus/extern/cursus?cursuscode=202000010&taal=en&collegejaar=huidig)).

### Procedure
The lectures in this course have **mandatory attendance**. Students are allowed to make use of generative AI in this course, see [the GenAI rules](https://mlarpis.github.io/markup/genai.html).
